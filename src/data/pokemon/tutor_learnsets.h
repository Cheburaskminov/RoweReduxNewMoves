const u16 gTutorMoves[TUTOR_MOVE_COUNT] =
{
    ...
    [TUTOR_MOVE_HEAVY_SLAM] = MOVE_HEAVY_SLAM,
    ...
    [TUTOR_MOVE_PETAL_BLIZZARD] = MOVE_PETAL_BLIZZARD,
    [TUTOR_MOVE_ELECTROWEB] = MOVE_ELECTROWEB,
    [TUTOR_MOVE_FUTURE_SIGHT] = MOVE_FUTURE_SIGHT,
